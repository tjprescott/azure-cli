...
def load_command_table(self, _):
    ...
    with self.command_group('network vnet', network_vnet_sdk) as g:
        ...
        g.custom_command('create', 'create_vnet', transform=transform_vnet_create_output, validator=process_vnet_create_namespace, supports_defer=True)
        g.generic_update_command('update', custom_func_name='update_vnet', supports_defer=True)
    ...
    with self.command_group('network vnet subnet', network_subnet_sdk) as g:
        g.custom_command('create', 'create_subnet', supports_defer=True)
        g.command('delete', 'delete')
        g.show_command('show', 'get')
        g.command('list', 'list')
