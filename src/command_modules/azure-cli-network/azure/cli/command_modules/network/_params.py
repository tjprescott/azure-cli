...
from azure.cli.core.commands.parameters import (get_location_type, get_resource_name_completion_list,
                                                tags_type, zone_type, get_enum_type,
...
from azure.cli.command_modules.network._validators import (
    ...
    validate_address_pool_id_list, load_cert_file, validate_metadata,
...
def load_arguments(self, _):
    ...
    with self.argument_context('network') as c:
        ...
        c.enum('private_ip_address_version', IPVersion)
        c.three_state_flag('enable_tcp_reset', help='Receive bidirectional TCP reset on TCP flow idle timeout or unexpected connection termination. Only used when protocol is set to TCP.', min_api='2018-07-01')
    ...
    with self.argument_context('network application-gateway') as c:
        ...
        c.enum('sku', ApplicationGatewaySkuName, default=ApplicationGatewaySkuName.standard_medium.value, arg_group='Gateway', help='The name of the SKU.')
    ...
    with self.argument_context('network application-gateway', arg_group='Gateway') as c:
        ...
        c.three_state_flag('http_settings_cookie_based_affinity', positive_label='Enabled', negative_label='Disabled', return_label=True, help='Enable or disable cookie-based affinity.')
        c.enum('http_settings_protocol', ApplicationGatewayProtocol, help='The HTTP settings protocol.')
        c.three_state_flag('enable_http2', positive_label='Enabled', negative_label='Disabled', options_list='--http2', help='Use HTTP2 for the application gateway.', min_api='2017-10-01')
    ...
    with self.argument_context('network application-gateway create') as c:
        ...
        c.enum('routing_rule_type', ApplicationGatewayRequestRoutingRuleType, arg_group='Gateway', help='The request routing rule type.')
    ...
    for item in ['http-settings', 'probe']:
        with self.argument_context('network application-gateway {}'.format(item)) as c:
            c.enum('protocol', ApplicationGatewayProtocol, help='The HTTP settings protocol.')
    ...
    with self.argument_context('network application-gateway http-settings') as c:
        c.three_state_flag('cookie_based_affinity', positive_label='Enabled', negative_label='Disabled', return_label=True, help='Enable or disable cookie-based affinity.')
        c.argument('timeout', help='Request timeout in seconds.')
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/probes/[probe]', arm_type='Microsoft.Network/applicationGateways', path='probes', help='Name or ID of the probe to associate with the HTTP settings.')
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/authenticationCertificates/[auth_certs]', arm_type='Microsoft.Network/applicationGateways', path='authenticationCertificates', nargs='+', min_api='2016-09-01', help='Space-separated list of authentication certificates (names or IDs) to associate with the HTTP settings.')
    ...
    with self.argument_context('network application-gateway rule') as c:
        c.subresource('Microsoft.Network/applicationGateways/[application_gatway_name]/backendAddressPools/[address_pool]', arm_type='Microsoft.Network/applicationGateways', path='backendAddressPools', help='The name or ID of the backend address pool.')
        c.subresource('Microsoft.Network/applicationGateways/[application_gatway_name]/httpListeners/[http_listener]', arm_type='Microsoft.Network/applicationGateways', path='httpListeners', help='The name or ID of the HTTP listener.')
        c.subresource('Microsoft.Network/applicationGateways/[application_gatway_name]/backendHttpSettingsCollections/[http_settings]', arm_type='Microsoft.Network/applicationGateways', path='backendHttpSettingsCollections', help='The name or ID of the backend HTTP settings.')
        c.argument('rule_type', help='The rule type (Basic, PathBasedRouting).')
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/urlPathMaps/[url_path_map]', arm_type='Microsoft.Network/applicationGateways', path='urlPathMaps', help='The name or ID of the URL path map.')
    ...
    with self.argument_context('network application-gateway ssl-policy') as c:
        ...
        c.enum('disabled_ssl_protocols', ApplicationGatewaySslProtocol, nargs='+', help='Space-separated list of protocols to disable.')
    ...
    with self.argument_context('network application-gateway url-path-map') as c:
        ...
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/backendAddressPools/[address_pool]', arm_type='Microsoft.Network/applicationGateways', path='backendAddressPools', help='The name or ID of the backend address pool to use with the created rule.', arg_group='First Rule')
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/backendHttpSettingsCollection/[http_settings]', arm_type='Microsoft.Network/applicationGateways', path='backendHttpSettingsCollection', help='The name or ID of the HTTP settings to use with the created rule.', arg_group='First Rule')

    with self.argument_context('network application-gateway url-path-map create') as c:
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/backendAddressPools/[default_address_pool]', arm_type='Microsoft.Network/applicationGateways', path='backendAddressPools', help='The name or ID of the default backend address pool, if different from --address-pool.')
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/backendHttpSettingsCollection/[default_http_settings]', arm_type='Microsoft.Network/applicationGateways', path='backendHttpSettingsCollection', help='The name or ID of the default HTTP settings, if different from --http-settings.')

    with self.argument_context('network application-gateway url-path-map update') as c:
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/backendAddressPools/[default_address_pool]', arm_type='Microsoft.Network/applicationGateways', path='backendAddressPools', help='The name or ID of the default backend address pool.')
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/backendHttpSettingsCollection/[default_http_settings]', arm_type='Microsoft.Network/applicationGateways', path='backendHttpSettingsCollection', help='The name or ID of the default HTTP settings.')
    ...
    with self.argument_context('network application-gateway url-path-map rule') as c:
        ...
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/backendAddressPools/[address_pool]', arm_type='Microsoft.Network/applicationGateways', path='backendAddressPools', help='The name or ID of the backend address pool. If not specified, the default for the map will be used.')
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/backendHttpSettingsCollections/[http_settings]', arm_type='Microsoft.Network/applicationGateways', path='backendHttpSettingsCollection', help='The name or ID of the HTTP settings. If not specified, the default for the map will be used.')
    ...
    with self.argument_context('network application-gateway waf-config') as c:
        ...
        c.three_state_flag('enabled', help='Specify whether the application firewall is enabled.')
        c.enum('firewall_mode', ApplicationGatewayFirewallMode, default='detection', min_api='2016-09-01', help='Web application firewall mode.')
    ...
    with self.argument_context('network application-gateway redirect-config', min_api='2017-06-01') as c:
        c.enum('redirect_type', ApplicationGatewayRedirectType, options_list=['--type', '-t'], help='HTTP redirection type')
        c.three_state_flag('include_path')
        c.three_state_flag('include_query_string')
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/httpListeners/[target_listener]', arm_type='Microsoft.Network/applicationGateways', path='httpListeners', help='Name or ID of the HTTP listener to redirect the request to.')
    ...
    with self.argument_context('network application-gateway http-settings', min_api='2017-06-01') as c:
        ...
        c.three_state_flag('host_name_from_backend_pool', help='Use host name of the backend server as the host header.')
        c.argument('affinity_cookie_name', help='Name used for the affinity cookie.')
        c.three_state_flag('enable_probe', help='Whether the probe is enabled.')
    ...
    with self.argument_context('network application-gateway probe', min_api='2017-06-01') as c:
        ...
        c.three_state_flag('host_name_from_http_settings', help='Use host header from HTTP settings.')
    ...
    with self.argument_context('network application-gateway url-path-map', min_api='2017-06-01') as c:
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/redirectConfigurations/[default_redirect_config]', arm_type='Microsoft.Network', path='redirectConfigurations', help='The name or ID of the default redirect configuration.')
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/redirectConfigurations/[redirect_config]', arm_type='Microsoft.Network', path='redirectConfigurations', help='The name or ID of the redirect configuration to use with the created rule.', arg_group='First Rule')

    with self.argument_context('network application-gateway rule', min_api='2017-06-01') as c:
        c.subresource('Microsoft.Network/applicationGateways/[application_gateway_name]/redirectConfigurations/[redirect_config]', arm_type='Microsoft.Network', path='redirectConfigurations', help='The name or ID of the redirect configuration to use with the created rule.')
    # endregion
    ...
    with self.argument_context('network ddos-protection') as c:
        ...
        c.subresource('Microsoft.Network/virtualNetworks/[vnets]', nargs='*', help='Space-separated list of VNet names or IDs to associate with the plan.')
    # endregion
    ...
    with self.argument_context('network dns zone') as c:
        ...
        c.enum('zone_type', ZoneType, help='Type of DNS zone to create.')
    ...
    with self.argument_context('network express-route') as c:
        ...
        c.enum('device_path', device_path_values, options_list='--path')
        c.argument('vlan_id', type=int)
        c.three_state_flag('allow_global_reach', min_api='2018-07-01', help='Enable global reach on the circuit.')
    ...
    with self.argument_context('network express-route peering') as c:
        ...
        c.argument('circuit_name', circuit_name_type)
        c.enum('peering_name', ExpressRoutePeeringType, validator=validate_peering_type, help='BGP peering type for the circuit.')
        c.enum('sku_family', ExpressRouteCircuitSkuFamily)
        c.enum('sku_tier', ExpressRouteCircuitSkuTier)
        ...
        c.enum('routing_registry_name', routing_registry_values, arg_group='Microsoft Peering', help='Internet Routing Registry / Regional Internet Registry')
        c.subresource('Microsoft.Network/routeFilters/[route_filter]', min_api='2016-12-01', arg_group='Microsoft Peering', help='Name or ID of a route filter to apply to the peering settings.')
        c.enum('ip_version', ['IPv4', 'IPv6'], min_api='2017-06-01', help='The IP version to update Microsoft Peering settings for.', arg_group='Microsoft Peering')
    ...
    with self.argument_context('network express-route peering connection') as c:
        ...
        c.subresource('Microsoft.Network/expressRouteCircuits/[peer_circuit]/peerings/[peering_name]', help='Name or ID of the peer ExpressRoute circuit.')
    # endregion
    ...
    with self.argument_context('network lb') as c:
        ...
        c.three_state_flag('floating_ip', help='Enable floating IP.')
        c.argument('idle_timeout', help='Idle timeout in minutes.')
        c.enum('protocol', TransportProtocol, help='Network transport protocol.')
    ...
    with self.argument_context('network lb create') as c:
        ...
        c.argument('validate', help='Generate and validate the ARM template without creating any resources.', action='store_true')
        c.enum('sku', LoadBalancerSkuName, default='basic', min_api='2017-08-01', help='Load balancer SKU')
    ...
    with self.argument_context('network lb create', arg_group='Public IP') as c:
        ...
        c.enum('public_ip_address_allocation', IPAllocationMethod, help='IP allocation method.')
    ...
    for item in ['create', 'update']:
        with self.argument_context('network lb frontend-ip {}'.format(item)) as c:
            c.subresource('Microsoft.Network/publicIPAddresses/[public_ip_address]', help='Name or ID of the existing public IP to associate with the configuration.')
            c.subresource('Microsoft.Network/virtualNetworks/[virtual_network_name]/subnets/[subnet]', help='Name or ID of an existing subnet. If name is specified, also specify --vnet-name.')
    ...
    with self.argument_context('network lb probe') as c:
        ...
        c.enum('protocol', ProbeProtocol, help='The protocol to probe.')
    ...
    with self.argument_context('network lb outbound-rule') as c:
        c.subresource('Microsoft.Network/loadBalancers/[load_balancer_name]/backendAddressPools/[backend_address_pool]', arm_type='Microsoft.Network/loadBalancers', path='backendAddressPools', options_list='--address-pool', help='Name or ID of the backend address pool.')
    ...
    with self.argument_context('network lb rule') as c:
        c.enum('load_distribution', LoadDistribution, help='Affinity rule settings.')
        c.argument('probe_name', help='Name of an existing probe to associate with this rule.')
        c.three_state_flag('disable_outbound_snat', min_api='2018-08-01', help='Configures SNAT for the VMs in the backend pool to use the publicIP address specified in the frontend of the load balancing rule.')
    # endregion
    ...
    with self.argument_context('network nic') as c:
        c.three_state_flag('enable_accelerated_networking', min_api='2016-09-01', options_list='--accelerated-networking', help='Enable accelerated networking.')
        ...
        c.three_state_flag('enable_ip_forwarding', options_list='--ip-forwarding', help='Enable IP forwarding.')
    ...
    with self.argument_context('network nic create') as c:
        ...
        c.subresource('Microsoft.Network/publicIPAddresses/[public_ip_address]', help=public_ip_help)

        nsg_help = get_folded_parameter_help_string('network security group', allow_none=True, default_none=True)
        c.subresource('Microsoft.Network/networkSecurityGroups/[network_security_group]', help=nsg_help)

        subnet_help = get_folded_parameter_help_string('subnet', other_required_option='--vnet-name')
        c.subresource('Microsoft.Network/virtualNetworks/[virtual_network_name]/subnets/[subnet]', path='subnets', arm_type='Microsoft.Network/virtualNetworks', help=subnet_help)
    ...
    with self.argument_context('network nic ip-config') as c:
        ...
        c.subresource('Microsoft.Network/publicIPAddresses/[public_ip_address]', help='Name or ID of the public IP to use.')
    ...
    with self.argument_context('network nic ip-config address-pool') as c:
        ...
        c.subresource('Microsoft.Network/loadBalancers/[load_balancer_name]/backendAddressPools/[backend_address_pool]', arm_type='Microsoft.Network/loadBalancers', path='backend_address_pools', options_list='--address-pool', help='The name or ID of an existing backend address pool.')
    ...
    with self.argument_context('network nic ip-config inbound-nat-rule') as c:
        ...
        c.subresource('Microsoft.Network/loadBalancers/[load_balancer_name]/inboundNatRules/[inbound_nat_rule]', arm_type='Microsoft.Network/loadBalancers', path='inbound_nat_rules', options_list='--inbound-nat-rule', help='The name or ID of an existing inbound NAT rule.')
    ...
    for item in ['create', 'update']:
        with self.argument_context('network nsg rule {}'.format(item)) as c:
            ...
            c.enum('access', SecurityRuleAccess, default=SecurityRuleAccess.allow.value if item == 'create' else None, help=None)
            c.enum('protocol', SecurityRuleProtocol, default=SecurityRuleProtocol.asterisk.value if item == 'create' else None, help='Network protocol this rule applies to.')
            c.enum('direction', SecurityRuleDirection, default=SecurityRuleDirection.inbound.value if item == 'create' else None, help=None)
    ...
    with self.argument_context('network watcher show-topology', arg_group='Target') as c:
        ...
        c.subresource('Microsoft.Network/virtualNetworks/[target_vnet]', options_list='--vnet', help='Name or ID of the virtual network to target.')
        c.subresource('Microsoft.Network/virtualNetworks/[target_vnet]/subnets/[target_subnet]', options_list='--subnet', help='Name or ID of the subnet to target. If name is used, --vnet NAME must also be supplied.')
    ...
    for item in ['test-ip-flow', 'show-next-hop', 'show-security-group-view', 'packet-capture create']:
        with self.argument_context('network watcher {}'.format(item)) as c:
            ...
            c.ignore('location')
            c.ignore('watcher_rg')
            c.subresource('Microsoft.Compute/virtualMachines/[vm]', help='Name or ID of the VM to target.')
            c.argument('resource_group_name', help='Name of the resource group the target VM is in. Do not use when supplying VM ID.')
            c.subresource('Microsoft.Network/networkInterfaces/[nic]', help='Name or ID of the NIC resource to test. If the VM has multiple NICs and IP forwarding is enabled on any of them, this parameter is required.')
    ...
    with self.argument_context('network watcher test-connectivity') as c:
        ...
        c.enum('protocol', Protocol, help='Protocol to test on.')

    with self.argument_context('network watcher test-connectivity', arg_group='HTTP Configuration') as c:
        c.enum('method', HTTPMethod, help='HTTP method to use.')
    ...
    with self.argument_context('network watcher flow-log') as c:
        c.subresource('Microsoft.Network/networkSecurityGroups/[nsg]', help='Name or ID of the network security group.')
        c.three_state_flag('enabled')
    ...
    with self.argument_context('network watcher test-ip-flow') as c:
        c.enum('direction', Direction)
        c.enum('protocol', Protocol)
    ...
    with self.argument_context('network watcher troubleshooting') as c:
        ...
        c.enum('resource_type', ['vnetGateway', 'vpnConnection'], help='The resource type', options_list=['--resource-type', '-t'], id_part='resource_type')
    ...
    with self.argument_context('network watcher run-configuration-diagnostic', arg_group='Target') as c:
        ...
        c.enum('resource_type', ['virtualMachines', 'networkInterfaces', 'applicationGateways'], help='The resource type', options_list=['--resource-type', '-t'], id_part='resource_type')
    ...
    with self.argument_context('network watcher run-configuration-diagnostic', arg_group='Query') as c:
        ...
        c.enum('direction', Direction, help='Direction of the traffic.')
        c.enum('protocol', Protocol, help='Protocol to be verified on.')
    ...
    for item in ['create', 'update']:
        with self.argument_context('network public-ip {}'.format(item)) as c:
            c.enum('allocation_method', IPAllocationMethod, help='IP address allocation method')
            c.enum('sku', PublicIPAddressSkuName, min_api='2017-08-01', help='Public IP SKU.', default=PublicIPAddressSkuName.basic.value if PublicIPAddressSkuName is not None and item == 'create' else None)
            c.enum('version', IPVersion, default='ipv4', min_api='2016-09-01', help='IP address type.')

    for scope in ['public-ip', 'lb frontend-ip']:
        with self.argument_context('network {}'.format(scope), min_api='2018-07-01') as c:
            c.subresource('Microsoft.Network/publicIPPrefixes/[public_ip_prefix]', help='Name or ID of a public IP prefix.')
    ...
    with self.argument_context('network route-filter rule') as c:
        ...
        c.enum('access', Access, help='The access type of the rule.')
    ...
    with self.argument_context('network route-table') as c:
        ...
        c.three_state_flag('disable_bgp_route_propagation', min_api='2017-10-01', help='Disable routes learned by BGP.')
    ...
    with self.argument_context('network route-table route') as c:
        ...
        c.enum('next_hop_type', RouteNextHopType, help='The type of Azure hop the packet should be sent to.')
    ...
    with self.argument_context('network traffic-manager profile') as c:
        ...
        c.enum('profile_status', ProfileStatus, options_list='--status', help='Status of the Traffic Manager profile.')
        c.enum('routing_method', ['Performance', 'Weighted', 'Priority', 'Geographic'], help='Routing method.')
    ...
    with self.argument_context('network traffic-manager endpoint') as c:
        ...
        c.enum('endpoint_type', endpoint_types, options_list=['--type', '-t'], help='Endpoint type.', id_part='child_name_1')
        ...
        c.enum('endpoint_status', ['Enabled', 'Disabled'], help="The status of the endpoint. If enabled the endpoint is probed for endpoint health and included in the traffic routing method.")
    ...
    with self.argument_context('network vnet') as c:
        ...
        c.three_state_flag('ddos_protection', help='Control whether DDoS protection is enabled.', min_api='2017-09-01')
        c.subresource('Microsoft.Network/ddosProtectionPlans/[ddos_protection_plan]', help='Name or ID of a DDoS protection plan to associate with the VNet.', min_api='2018-02-01')
        c.three_state_flag('vm_protection', help='Enable VM protection for all subnets in the VNet.', min_api='2017-09-01')
    ...
    with self.argument_context('network vnet subnet') as c:
        ...
        c.argument('virtual_network_name', virtual_network_name_type)
        c.subresource('Microsoft.Network/networkSecurityGroups/[network_security_group]', help='Name or ID of a network security group (NSG).')
        c.subresource('Microsoft.Network/routeTables/[route_table]', help='Name or ID of a route table to associate with the subnet.')
    ...
    with self.argument_context('network vnet subnet update') as c:
        c.subresource('Microsoft.Network/networkSecurityGroups/[network_security_group]', help='Name or ID of a network security group (NSG). Use empty string "" to detach it.')
    ...
    with self.argument_context('network vnet-gateway') as c:
        ...
        c.subresource('Microsoft.Network/publicIPAddresses/[public_ip_address]', options_list='--public-ip-addresses', nargs='+', help='Specify a single public IP (name or ID) for an active-standby gateway. Specify two space-separated public IPs for an active-active gateway.')
        ...
        c.enum('client_protocol', VpnClientProtocol, min_api='2017-06-01', help='Protocols to use for connecting', nargs='+', arg_group='VPN Client')
    ...
    with self.argument_context('network vnet-gateway create') as c:
        ...
        c.subresource('Microsoft.Network/virtualNetworks/[virtual_network]', options_list='--vnet', help=vnet_help)

    with self.argument_context('network vnet-gateway update') as c:
        c.three_state_flag('enable_bgp', help='Enable BGP (Border Gateway Protocol)', arg_group='BGP Peering')
        c.subresource('Microsoft.Network/virtualNetworks/[virtual_network]', options_list='--vnet', help="Name or ID of a virtual network that contains a subnet named 'GatewaySubnet'.")
    ...
    with self.argument_context('network vnet-gateway vpn-client') as c:
        c.enum('processor_architecture', ProcessorArchitecture, help='Processor architecture of the target system.')
        c.enum('authentication_method', AuthenticationMethod, help='Method used to authenticate with the generated client.')
        ...
        c.three_state_flag('use_legacy', min_api='2017-06-01', help='Generate VPN client package using legacy implementation.')
    # endregion
    ...
    with self.argument_context('network vpn-connection') as c:
        ...
        c.three_state_flag('use_policy_based_traffic_selectors', min_api='2017-03-01', help='Enable policy-based traffic selectors.')
    ...
    with self.argument_context('network vpn-connection update') as c:
        c.three_state_flag('enable_bgp', help='Enable BGP (Border Gateway Protocol)')
